    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex justify-center mb-6">
              <div className="w-full md:w-4/5 max-w-2xl">
                <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663416505971/mjJtHysgoNjHJolG.png" alt="Mercado em movimento - Tempo e oportunidade" className="w-full h-auto object-contain border-2 rounded-lg image-glow image-border-gradient" />
              </div>
            </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex justify-center mb-8">
              <div className="w-full md:w-4/5 max-w-2xl">
                <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663416505971/kcDPWTAXlRdnMVsL.png" alt="Operação Resgate - Missão" className="w-full h-auto object-contain border-2 rounded-lg image-glow image-border-gradient" />
              </div>
            </div>
      ...
      <section id="o-plano" data-section="plano" className="py-20 md:py-32 bg-secondary/30">
        <div className="container">
          ...
          {/* O que é o Protocolo Resgate */}
          <div className="mb-20 bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/20 rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-center mb-12 text-primary">O que é o Protocolo Resgate</h3>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <p className={`text-lg leading-relaxed mb-8 transition-all duration-700 ${visibleSections["diferencial"] ? "animate-fadeInUp" : "opacity-0"}`}>
              Por que a maioria falha onde você poderá ter sucesso? <span className="font-bold" style={{color: '#0066FF'}}>Porque eles não dominam a própria mente.</span>       </p>
